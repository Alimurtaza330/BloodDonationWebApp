...
const VerifyPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await axios.post('https://bloodonationwebapp.vercel.app/api/auth/verify', { code });
  ...
  const handleResendCode = async () => {
    try {
      setResending(true);
      const response = await axios.post('https://bloodonationwebapp.vercel.app/api/resend-code', { email });
